<script lang="ts">
    ...
    let sumLine: Line2;
    let sumArrowHelper: THREE.ArrowHelper;

    let ghostLine1: Line2;
    let ghostArrowHelper1: THREE.ArrowHelper;
    ...
    onMount( () => {
        ...
        scene.add( ghostLine1, ghostArrowHelper1 );
        scene.add( ghostLine2, ghostArrowHelper2 );
        scene.add( sumLine, sumArrowHelper );
